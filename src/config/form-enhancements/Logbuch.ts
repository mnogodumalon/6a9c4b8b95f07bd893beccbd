// Auto-generated. Per-entity form-enhancements config for "Logbuch".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'startzeit': { kind: 'today', withTime: true },
    'zweck': { kind: 'lookup', key: 'trainingsfahrt', label: 'Trainingsfahrt' },
    'gastruderer_anzahl': { kind: 'literal', value: 0 },
    'schaden_gemeldet': { kind: 'literal', value: false },
  },
  computed: {
    '_logbuch_fahrzeit_stunden': { kind: 'dateDiff', from: 'startzeit', to: 'endzeit', unit: 'hours' },
  },
};
