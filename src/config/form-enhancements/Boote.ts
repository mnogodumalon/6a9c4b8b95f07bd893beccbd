// Auto-generated. Per-entity form-enhancements config for "Boote".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'boot_status': { kind: 'lookup', key: 'verfuegbar', label: 'Verfügbar' },
    'steuermann_erforderlich': { kind: 'literal', value: false },
  },
  computed: {},
};
