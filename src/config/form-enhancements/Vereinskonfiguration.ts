// Auto-generated. Per-entity form-enhancements config for "Vereinskonfiguration".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'sekundaerfarbe',
    'bootshaus_name',
    { row: ['bootshaus_adresse_strasse', 'bootshaus_adresse_hausnummer'], cols: '2fr 1fr' },
    { row: ['bootshaus_adresse_plz', 'bootshaus_adresse_ort'], cols: '1fr 2fr' },
  ],
  defaults: {},
  computed: {},
};
