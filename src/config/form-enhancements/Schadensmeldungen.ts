// Auto-generated. Per-entity form-enhancements config for "Schadensmeldungen".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'meldungstyp': { kind: 'lookup', key: 'bootsschaden', label: 'Bootsschaden' },
    'status_meldung': { kind: 'lookup', key: 'offen', label: 'Offen' },
  },
  computed: {},
};
