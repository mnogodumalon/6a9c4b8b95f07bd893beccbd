...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Ruderverein Logbuch",
    "apps": {
      "mitglieder": {
        "name": "Mitglieder",
        "app_id": "6a9c4b63d28dc5bea78a8881",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
          ...
          "status": "Status",
          "rollen": "Rollen im Verein",
          "notizen_mitglied": "Interne Notizen"
        },
        "lookups": {
          "status": {
            "aktiv": "Aktiv",
      ...
      "boote": {
        "name": "Boote",
        "app_id": "6a9c4b6916b903d9a0d4816b",
        "fields": {
          "name": "Bootsname",
          "bootstyp": "Bootstyp",
          "max_ruderer": "Maximale Rudererzahl",
          "steuermann_erforderlich": "Steuermann erforderlich",
          "baujahr": "Baujahr",
          "hersteller": "Hersteller / Marke",
          "zustand": "Zustand",
          "boot_status": "Status",
          "lagerplatz": "Lagerplatz im Bootshaus",
          "notizen_boot": "Notizen zum Boot"
        },
        "lookups": {
          "bootstyp": {
            "einer": "Einer (1x)",
            "zweier_ohne": "Zweier ohne Steuermann (2-)",
            "zweier_mit": "Zweier mit Steuermann (2+)",
            "doppelzweier": "Doppelzweier (2x)",
            "vierer_ohne": "Vierer ohne Steuermann (4-)",
            "vierer_mit": "Vierer mit Steuermann (4+)",
            "doppelvierer": "Doppelvierer (4x)",
            "doppelvierer_mit": "Doppelvierer mit Steuermann (4x+)",
            "achter": "Achter (8+)",
            "gig_zweier": "Gig-Zweier",
            "gig_vierer": "Gig-Vierer",
            "gig_achter": "Gig-Achter",
            "sonstiges": "Sonstiges"
          },
          "max_ruderer": {
            "ruderer_1": "1 Ruderer",
          ...
          "zustand": {
            ...
            "reparaturbeduertig": "Reparaturbedürftig"
          },
          "boot_status": {
      ...
      "logbuch": {
        "name": "Logbuch",
        "app_id": "6a9c4b6a026e7a4c02f93855",
        "fields": {
          "boot": "Boot",
          "startzeit": "Startzeit",
          "zweck": "Zweck der Ausfahrt",
          "ruderer": "Ruderer",
          "steuermann": "Steuermann",
          "gastruderer_anzahl": "Anzahl Gastruderer",
          "gastruderer_namen": "Namen der Gastruderer",
          "endzeit": "Endzeit",
          "strecke_km": "Gefahrene Strecke (km)",
          "veranstaltungsort": "Ort / Gewässer",
          "schaden_gemeldet": "Bootsschaden melden",
          "allgemeine_notizen": "Allgemeine Notizen"
        },
        "lookups": {
          "zweck": {
            "trainingsfahrt": "Trainingsfahrt",
            "regatta": "Regatta",
      ...
      "schadensmeldungen": {
        ...
        "app_id": "6a9c4b6bf9f4552fbbc0e06d",
        "fields": {
          "ausfahrt": "Zugehörige Ausfahrt",
          "meldungstyp": "Art der Meldung",
          "titel": "Kurzbeschreibung",
          "beschreibung": "Detaillierte Beschreibung",
          "schweregrad": "Schweregrad (bei Schaden)",
          "foto": "Foto des Schadens",
          "status_meldung": "Status der Meldung",
          "erledigt_am": "Erledigt am",
          "bootswart_notiz": "Notiz des Bootswarts"
        },
        "lookups": {
          "meldungstyp": {
            "bootsschaden": "Bootsschaden",
            "allgemeine_notiz": "Allgemeine Notiz",
            "sicherheitshinweis": "Sicherheitshinweis"
          },
          "schweregrad": {
            "gering": "Gering – Boot weiterhin nutzbar",
            "mittel": "Mittel – eingeschränkte Nutzung",
            "hoch": "Hoch – Boot nicht nutzbar"
          },
          "status_meldung": {
            "offen": "Offen",
      ...
      "vereinskonfiguration": {
        "name": "Vereinskonfiguration",
        "app_id": "6a9c4b6c2b88bee26559df31",
        "fields": {
          "vereinsname": "Vereinsname",
          "vereinskuerzel": "Vereinskürzel",
          "gruendungsjahr": "Gründungsjahr",
          "vereinswebsite": "Website des Vereins",
          "vereinsemail": "Kontakt-E-Mail",
          "logo": "Vereinslogo",
          "primaerfarbe": "Primärfarbe (Hex-Code)",
          "sekundaerfarbe": "Sekundärfarbe (Hex-Code)",
          "vereinsmotto": "Vereinsmotto / Slogan",
          "bootshaus_name": "Name des Bootshauses",
          "bootshaus_adresse_strasse": "Straße",
          "bootshaus_adresse_hausnummer": "Hausnummer",
          "bootshaus_adresse_plz": "Postleitzahl",
          "bootshaus_adresse_ort": "Ort"
        },
        "lookups": {}
      }
    }
    ...
    "apps": {
      "mitglieder": {
        ...
        "fields": {
          ...
          "status": "Status",
          "rollen": "Club Roles",
          "notizen_mitglied": "Internal Notes"
        },
        "lookups": {
          "status": {
            "aktiv": "Active",
      ...
      "boote": {
        ...
        "fields": {
          "name": "Boat Name",
          "bootstyp": "Boat Type",
          "max_ruderer": "Maximum Number of Rowers",
          "steuermann_erforderlich": "Coxswain Required",
          "baujahr": "Year Built",
          "hersteller": "Manufacturer / Brand",
          "zustand": "Condition",
          "boot_status": "Status",
          "lagerplatz": "Storage Location in Boathouse",
          "notizen_boot": "Boat Notes"
        },
        "lookups": {
          "bootstyp": {
            "einer": "Single (1x)",
            "zweier_ohne": "Coxless Pair (2-)",
            "zweier_mit": "Coxed Pair (2+)",
            "doppelzweier": "Double Scull (2x)",
            "vierer_ohne": "Coxless Four (4-)",
            "vierer_mit": "Coxed Four (4+)",
            "doppelvierer": "Quadruple Scull (4x)",
            "doppelvierer_mit": "Coxed Quadruple Scull (4x+)",
            "achter": "Eight (8+)",
            "gig_zweier": "Gig Pair",
            "gig_vierer": "Gig Four",
            "gig_achter": "Gig Eight",
            "sonstiges": "Other"
          },
          "max_ruderer": {
            "ruderer_1": "1 Rower",
          ...
          "zustand": {
            ...
            "gut": "Good",
            "befriedigend": "Fair",
            "reparaturbeduertig": "Needs Repair"
          },
          "boot_status": {
            "verfuegbar": "Available",
            "in_reparatur": "Under Repair",
            "ausser_betrieb": "Out of Service",
            "gesperrt": "Locked"
          }
        }
      },
      "logbuch": {
        ...
        "fields": {
          ...
          "zweck": "Purpose of Outing",
          "ruderer": "Rower",
          "steuermann": "Coxswain",
          "gastruderer_anzahl": "Number of Guest Rowers",
          "gastruderer_namen": "Names of Guest Rowers",
          "endzeit": "End Time",
          "strecke_km": "Distance Rowed (km)",
          "veranstaltungsort": "Location / Waterway",
          "schaden_gemeldet": "Report Boat Damage",
          "allgemeine_notizen": "General Notes"
        },
        "lookups": {
          "zweck": {
            "trainingsfahrt": "Training Row",
            "regatta": "Regatta",
            "trainingslager": "Training Camp",
            "wanderfahrt": "Touring Row",
            "vereinsfahrt": "Club Outing",
            "probefahrt": "Trial Row",
            "sonstiges": "Other"
          }
        }
      },
      "schadensmeldungen": {
        ...
        "app_id": "6a9c4b6bf9f4552fbbc0e06d",
        "fields": {
          "ausfahrt": "Related Outing",
          "meldungstyp": "Report Type",
          "titel": "Brief Description",
          "beschreibung": "Detailed Description",
          "schweregrad": "Severity (for Damage)",
          "foto": "Photo of Damage",
          "status_meldung": "Report Status",
          "erledigt_am": "Resolved On",
          "bootswart_notiz": "Boat Keeper's Note"
        },
        "lookups": {
          "meldungstyp": {
            "bootsschaden": "Boat Damage",
            "allgemeine_notiz": "General Note",
            "sicherheitshinweis": "Safety Notice"
          },
          "schweregrad": {
            "gering": "Low – Boat Still Usable",
            "mittel": "Medium – Limited Use",
            "hoch": "High – Boat Not Usable"
          },
          "status_meldung": {
            "offen": "Open",
      ...
      "vereinskonfiguration": {
        ...
        "fields": {
          ...
          "vereinskuerzel": "Club Abbreviation",
          "gruendungsjahr": "Year Founded",
          "vereinswebsite": "Club Website",
          "vereinsemail": "Contact E-Mail",
          "logo": "Club Logo",
          "primaerfarbe": "Primary Color (Hex Code)",
          "sekundaerfarbe": "Secondary Color (Hex Code)",
          "vereinsmotto": "Club Motto / Slogan",
          "bootshaus_name": "Boathouse Name",
          "bootshaus_adresse_strasse": "Street",
          "bootshaus_adresse_hausnummer": "House Number",
          "bootshaus_adresse_plz": "Postal Code",
          "bootshaus_adresse_ort": "City"
        },
        "lookups": {}
      }
    }
